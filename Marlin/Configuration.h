...
#define CUSTOM_MACHINE_NAME "NonAir´s 32bit"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  10.00,  10.00 }
    #define DEFAULT_Ki_LIST {   0.51,   0.51 }
    #define DEFAULT_Kd_LIST {  49.70,  49.70 }
  #else
    #define DEFAULT_Kp  10.00
    #define DEFAULT_Ki   0.51
    #define DEFAULT_Kd  49.70
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.5, 397.4, 420 }
